    ...
    <div v-if="group" class="mt-3">
      <article class="card surface-card overflow-hidden">
        ...
        <div class="card-body p-4 p-lg-5">
          ...
          <p class="content-subtle">Created by {{ group.creatorName }}</p>
          ...
          <p v-else class="text-muted mt-4 mb-0">Login to join this group!</p>
        </div>
      </article>
      ...
      <div class="card surface-card mt-4">
        <div class="card-body p-4 p-lg-5">
          ...
          <p v-else class="text-muted mb-0">No members yet.</p>
        </div>
      </div>
    </div>
  </section>
